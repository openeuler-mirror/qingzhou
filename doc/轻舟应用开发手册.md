...
`qingzhou.properties`文件位于应用`src/main/resources`目录, 本配置文件用于存储应用配置参数。
#### 配置参数
...
#### 参数配置样例
```
qingzhou.app.main.class=qingzhou.app.master.Main
qingzhou.app.scan.filename=master-app
qingzhou.app.scan.include=qingzhou.app
qingzhou.app.scan.exclude=
```
#### 获取配置参数
...
public class ExampleMain implements QingzhouApp {
    ...
    @Override
    public void getAppProperties(AppContext appContext) {
        Properties properties = appContext.getAppProperties();
        String mainClass      = properties.getProperty("qingzhou.app.main.class");
        String scanFilename   = properties.getProperty("qingzhou.app.scan.filename");
        String scanInclude    = properties.getProperty("qingzhou.app.scan.include");
        String scanExclude    = properties.getProperty("qingzhou.app.scan.exclude");

        System.out.println("main class: " + mainClass);
        System.out.println("scan filename: " + scanFilename);
        System.out.println("scan include: " + scanInclude);
        System.out.println("scan exclude: " + scanExclude);
    }
}
```