...
public class Dashboard extends RedisModelBase implements Monitor {
    ...
    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.line, group = "clients",
            name = {"连接数", "en:Connected Clients"},
            info = {"当前连接的客户端数量", "en:Number of connected clients"})
    public String connectedClients;

    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.stat, group = "clients",
    ...
    @ModelField(field_type = FieldType.monitor, chart_type = ChartType.stat, group = "memory",
    ...
    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.stat, group = "memory",
    ...
    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.line, group = "keys",
            name = {"Key 总数", "en:Total Keys"},
            info = {"所有数据库中的 Key 总数", "en:Total number of keys across all databases"})
    public String totalKeys;

    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.line, group = "quality",
            name = {"命中率(%)", "en:Hit Rate(%)"},
            info = {"缓存命中率（keyspace_hits / total_ops）", "en:Cache hit rate"})
    public String hitRate;

    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.line, group = "ops",
            name = {"每秒操作数", "en:Ops/Sec"},
            info = {"每秒执行的操作数", "en:Number of operations per second"})
    public String opsPerSec;

    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.stat, group = "keys",
