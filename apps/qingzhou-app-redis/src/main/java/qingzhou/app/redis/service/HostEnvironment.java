...
public class HostEnvironment extends RedisModelBase implements Monitor {
    ...
    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.gauge, group = "cpu",
    ...
    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.line, group = "memory",
    ...
    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.line, group = "swap",
    ...
    @ModelField(field_type = FieldType.monitor, numeric = true, chart_type = ChartType.bar, group = "file",
