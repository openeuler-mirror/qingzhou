...
public class SystemController implements ServletContextListener, javax.servlet.Filter {
    ...
    public static Config getConfig() {
        return Controller.framework.getService(Config.class);
    }

    public static AppManager getAppManager() {
        return Controller.framework.getService(AppManager.class);
    }
    ...
    public static Serializer getSerializer() {
        return Controller.framework.getService(Serializer.class);
    }

    public static CryptoService getCryptoService() {
        return Controller.framework.getService(CryptoService.class);
    }

    public static Logger getLogger() {
        return Controller.framework.getService(Logger.class);
    }
