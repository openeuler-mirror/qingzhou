...
<ol class="breadcrumb" style="font-size: 15px; margin-bottom: 0; min-width: 300px; padding: 10px 5px !important;">
    <li class="active" style="margin-left:-5px;">
        <div class="model-info">
            ...
            <span class="tooltips" data-tip='<%=I18n.getString(menuAppName, "model.info." + qzRequest.getModelName())%>'
    ...
    <%
        if (!Objects.equals(I18n.getString(menuAppName, "model.action." + qzRequest.getModelName() + "." + qzRequest.getModelName()), I18n.getString(menuAppName, "model." + qzRequest.getModelName()))) {
            if (I18n.getString(menuAppName, "model.action." + qzRequest.getModelName() + "." + qzRequest.getActionName()) != null) {
    %>
    <li class="active">
