...
<%
	...
	String url = PageBackendService.buildRequestUrl(request, response, qzRequest, DeployerConstants.jsonView, DeployerConstants.ACTION_MONITOR + (Utils.notBlank(encodedId) ? "/" + encodedId : ""));
%>
