                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a id="reset-password-btn"
                           href="<%=RESTController.encodeURL( response, (contextPath.endsWith("/") ? contextPath.substring(0, contextPath.length() - 1) : contextPath) + DeployerConstants.REST_PREFIX + "/" + ViewManager.htmlView + "/" + DeployerConstants.APP_SYSTEM +"/" + DeployerConstants.MODEL_PASSWORD + "/" + Constants.ACTION_EDIT)%>"
