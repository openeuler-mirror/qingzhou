...
<form name="pageForm" method="post" class="form-horizontal"
	  action="<%=PageBackendService.buildRequestUrl(request, response, qzRequest, DeployerConstants.jsonView, submitActionName + (isEdit ? "/" + encodedId: ""))%>">
	<div class="block-bg" style="padding-top: 24px; padding-bottom: 1px;">
		...
		<div class="block-bg" style="margin-top: 15px; height: 64px; text-align: center;">
			<div class="form-btn">
				...
				%>
				<a href='<%=PageBackendService.buildRequestUrl(request, response, qzRequest, DeployerConstants.jsonView, Downloadable.ACTION_FILES + "/" + encodedId)%>'
						<%
