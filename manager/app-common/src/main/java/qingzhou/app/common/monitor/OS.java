...
@Model(code = "os", icon = "desktop", name = {"操作系统", "en:Operating System"}, info = {"操作系统的基本信息。", "en:Basic information about the operating system."})
public class OS extends ModelBase implements Monitorable {
    ...
    @ModelField(supportGraphical = true, name = {"CPU负载", "en:Load Average"},
    ...
    @ModelField(supportGraphical = true, name = {"总物理内存（GB）", "en:Total Physical Memory (GB)"},
            info = {"操作系统的总物理内存，单位GB。", "en:The total physical memory of the operating system, in GB."})
    public Double TotalPhysicalMemorySize;

    @ModelField(supportGraphical = true, name = {"空闲物理内存（GB）", "en:Free Physical Memory (GB)"}, info = {"操作系统的空闲物理内存，单位GB。", "en:Free physical memory of operating system, in GB."})
    public Double FreePhysicalMemorySize;

    @ModelField(supportGraphical = true, name = {"总交换空间（GB）", "en:Total Exchange Space (GB)"}, info = {"操作系统的总交换空间，单位GB。", "en:Total exchange space of operating system, in GB."})
    public Double TotalSwapSpaceSize;

    @ModelField(supportGraphical = true, name = {"空闲交换空间（GB）", "en:Free Swap Space (GB)"}, info = {"操作系统的空闲交换空间，单位GB。", "en:Free swap space of operating system, in GB."})
    public Double FreeSwapSpaceSize;

    @ModelField(supportGraphical = true, name = {"当前虚拟内存（GB）", "en:Current Virtual Memory (GB)"}, info = {"操作系统的当前虚拟内存，单位GB。", "en:Current virtual memory of operating system, in GB."})
    private Double CommittedVirtualMemorySize;

    @ModelField(supportGraphical = true, name = {"磁盘分区总量（GB）", "en:File Total Space (GB)"},
    ...
    @ModelField(supportGraphical = true, name = {"磁盘分区剩余（GB）", "en:File Free Space (GB)"},
