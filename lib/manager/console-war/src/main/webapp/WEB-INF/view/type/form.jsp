...
<%
    ...
    sameLineMap.values().stream().flatMap((Function<List<String>, Stream<String>>) Collection::stream).forEach(f -> sameLineModelData.put(f, finalModelData.remove(f)));
...
<div class="bodyDiv">
    ...
    <form name="pageForm" method="post" class="form-horizontal"
        ...
        <div style="margin-top: 15px; height: 64px; text-align: center;">
            <div class="form-btn">
                <%
                    if (SecurityController.isActionPermitted(qzApp, qzModel, submitActionName, request, modelData)) {
                %>
                ...
                <%
                    ...
                    for (String formAction : formActions) {
                        boolean actionPermitted = SecurityController.isActionPermitted(qzApp, qzModel, formAction, request, modelData);
                ...
                <a href="<%=PageUtil.buildRequestUrl(request, response, qzRequest, DownloadView.FLAG, formAction)%>"
                   action-type="<%=ActionType.qr%>" class="btn">
                ...
                <%
                    ...
                    if (SecurityController.isActionPermitted(qzApp, qzModel, qingzhou.api.type.List.ACTION_LIST, request, modelData)) {
                %>
