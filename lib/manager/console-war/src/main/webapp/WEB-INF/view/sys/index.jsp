...
<script>
    var global_setting = {
        ...
        "actionId_app_manage": '<%=DeployerConstants.APP_MASTER + "-" + DeployerConstants.MODEL_APP + "-" + DeployerConstants.ACTION_MANAGE%>',
        "actionId_app_stop-delete": '<%=DeployerConstants.APP_MASTER + "-" + DeployerConstants.MODEL_APP + "-" + Delete.ACTION_DELETE%>' + ',' + '<%=DeployerConstants.APP_MASTER + "-" + DeployerConstants.MODEL_APP + "-" + DeployerConstants.ACTION_STOP%>',
