...
<%
    String imagePath = getServletContext().getRealPath("/static/images/guide");
    File folder = new File(imagePath);
    List<String> imageNames = new ArrayList<>();
    if (folder.exists()) {
        File[] imageFiles = folder.listFiles((a, name) -> {
        ...
        if (imageFiles != null) {
            for (File file : imageFiles) {
                imageNames.add(contextPath + "/static/images/guide/" + file.getName());
            }
        }
    }
%>
