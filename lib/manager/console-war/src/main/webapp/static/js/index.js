...
function popupAction(actionId, restrictedArea, getDataUrl) {
    var sub_form_action_div = $("div[sub_form_action_id='" + actionId + "']", restrictedArea);
    let html = sub_form_action_div.html();
    var formLoadedTrigger = sub_form_action_div.attr("sub_form_autoload");
    var autoClose = sub_form_action_div.attr("sub_form_autoclose");
    var actionUrl = sub_form_action_div.attr("sub_form_action_url");
