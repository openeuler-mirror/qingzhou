...
function popupAction(actionId, restrictedArea, autoloadId) {
    ...
    if (questionMarkIndex !== -1) {
        actionUrl = baseUrl.slice(0, questionMarkIndex) + "/" + sub_form_action_div.attr("sub_form_action_name") + baseUrl.slice(questionMarkIndex);
    } else {
        actionUrl = baseUrl + "/" + sub_form_action_div.attr("sub_form_action_name");
    }
