...
public class AppManagerImpl implements AppManager {
    ...
    public AppManagerImpl(ModuleContext moduleContext) {
    ...
    private AppInfoImpl buildApp(String appName, File appDir, boolean needCommonModel) throws Exception {
        ...
        if (needCommonModel) {
            File[] commonFiles = FileUtil.newFile(moduleContext.getLibDir(), "module", "qingzhou-app", "common").listFiles();
            if (commonFiles != null) {
        ...
        for (File file : appLibs) {
            ...
            try (JarFile jar = new JarFile(file)) {
                ...
                while (entries.hasMoreElements()) {
                    ...
                    if (cls.getDeclaredAnnotation(App.class) != null) {
                        return cls;
                    }
                }
            }
