...
public class Controller implements Module {
    ...
    private class StartServer implements Process {
        ...
        private byte[] process(InputStream in) throws Exception {
            ...
            // 3. 处理请求
            Serializer serializer = moduleContext.getService(Serializer.class);
        ...
        private void register() {
            ...
            masters.forEach(master -> {
                try {
                    ...
                    moduleContext.getService(Logger.class).warn("An exception occurred during the registration process", e);
                }
            });
        }
    }
