...
public class HexUtil {
     ...
     * @since 1.7
     */
    public HexUtil(final Charset charset) {
     ...
     */
    public HexUtil(final String charsetName) {
     ...
     * @return A byte array containing binary data decoded from the supplied byte array (representing characters).
     * @ DecoderException Thrown if an odd number of characters is supplied to this function or the object is not
     * a String or char[]
     * @see #decodeHex(char[])
     */
