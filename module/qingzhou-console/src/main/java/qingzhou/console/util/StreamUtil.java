...
public class StreamUtil {
    public static void readInputStreamWithThread(InputStream inputStream, CollectorUtil output, String name) {
    ...
    private static class StreamConsumer implements Runnable {
        InputStream is;
        String type;
        CollectorUtil output;

        public StreamConsumer(InputStream inputStream, String type, CollectorUtil output) {
            this.is = inputStream;
            this.type = type;
            this.output = output;
        }
