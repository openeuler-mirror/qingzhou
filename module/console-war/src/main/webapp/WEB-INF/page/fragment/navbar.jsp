            ...
            <div >
                ...
                <ul class="nav navbar-nav navbar-right">
                   <%-- 快捷搜索 --%>
                    ...
                    <%-- 用户/修改密码 --%>
                    <li>
                        <a id="reset-password-btn" href="<%=PageBackendService.encodeURL( response, ViewManager.htmlView+"/"+ FrameworkContext.MANAGE_TYPE_APP +"/"+ FrameworkContext.SYS_APP_MASTER +"/password/"+ "edit")%>"
