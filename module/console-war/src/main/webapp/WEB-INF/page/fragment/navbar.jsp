        ...
        <div class="collapse navbar-collapse">
            <div >
                <ul class="nav navbar-nav">
                    <li><span class="console-name"><%=I18n.getString(Constants.MASTER_APP_NAME, "page.index")%></span></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                   <%-- 快捷搜索 --%>
                    <li>
                       <div class="searchBar">
                            <div class="sample">
                                 <input type="text" id="searchText" name="search" placeholder="<%=I18n.getString(Constants.MASTER_APP_NAME, "page.filter")%>">
                    ...
                    <%-- 新手引导 --%>
                    <li>
                        <a id="guide-btn" href="javascript:void(0);" class="tooltips" data-tip='<%=I18n.getString(Constants.MASTER_APP_NAME, "page.guide")%>' data-tip-arrow="bottom">
                    ...
                    <li id="switch-lang" class="dropdown">
                        <a href="javascript:void(0);" data-toggle="dropdown"
                           class="tooltips" data-tip='<%=I18n.getString(Constants.MASTER_APP_NAME, "page.lang.switch")%>' data-tip-arrow="bottom">
                            <span class="circle-bg">
                    ...
                    <li>
                        ...
                        class="tooltips" data-tip='<%=I18n.getString(Constants.MASTER_APP_NAME, "page.invalidate")%>' data-tip-arrow="bottom">
                            <span class="circle-bg">
