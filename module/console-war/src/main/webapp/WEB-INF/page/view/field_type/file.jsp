...
<div id="uploader" class="uploader">
    <a href="javascript:;" onclick="$('#<%=tempId%>').click();" class="btn uploader-btn-browse"
       style="width: 108px; height: 32px; border-radius: 1px; background: #FFFFFF;">
        ...
        <span style="padding-left: 6px; font-family: PingFangSC-Regular; font-size: 14px; color: #262626; line-height: 20px;"><%=I18n.getString(ConsoleConstants.MASTER_APP_NAME, "page.selectfile")%></span>
    </a>
    <%--
    <!-- <a href="javascript:;"
