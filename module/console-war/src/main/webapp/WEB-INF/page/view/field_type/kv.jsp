...
<div class="form-control-kv">
    ...
    <table class="kv table table-bordered">
        <tr>
            <th style="padding:0px 0px !important; width: 30%; text-align: center; vertical-align: middle"><%=I18n.getString(Constants.MASTER_APP_NAME, "page.info.kv.name")%></th>
            <th style="padding:0px 0px !important; text-align: center; vertical-align: middle"><%=I18n.getString(Constants.MASTER_APP_NAME, "page.info.kv.value")%></th>
