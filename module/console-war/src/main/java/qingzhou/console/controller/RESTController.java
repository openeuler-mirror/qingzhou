...
public class RESTController extends HttpServlet {
    ...
    public static final String INDEX_PATH = REST_PREFIX + "/" + ViewManager.htmlView + "/" + Constants.MODEL_NAME_node + "/" + qingzhou.api.Constants.LOCAL_NODE_NAME + "/" + Constants.MASTER_APP_NAME + "/" + Constants.MODEL_NAME_index + "/" + Constants.ACTION_NAME_INDEX;
