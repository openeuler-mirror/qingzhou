...
public class RESTController extends HttpServlet {
    ...
    public static final String INDEX_PATH = REST_PREFIX + "/" + ViewManager.htmlView + "/" + Constants.MODEL_NAME_instance + "/" + Constants.QINGZHOU_MASTER_APP_NAME + "/" + Constants.MODEL_NAME_index + "/" + Constants.ACTION_NAME_INDEX;
