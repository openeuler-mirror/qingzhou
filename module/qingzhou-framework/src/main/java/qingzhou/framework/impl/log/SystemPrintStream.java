package qingzhou.framework.impl.log;
...
public class SystemPrintStream extends PrintStream {
    ...
    private static volatile boolean takeoverSystemPrint = true;// todo 需要可配置吗？
    ...
    public static void reload() {
        takeoverSystemPrint = true;// todo 需要可配置吗？
    }

    private final boolean useWarnLevel;
    private final Logger logger;

    public SystemPrintStream(boolean useWarnLevel, Logger logger) {
