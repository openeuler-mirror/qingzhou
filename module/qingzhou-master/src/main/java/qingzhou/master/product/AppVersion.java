package qingzhou.master.product;
...
@Model(name = "appversion", icon = "rss",
...
public class AppVersion extends MasterModelBase implements AddModel {
    ...
    public void add(Request request, Response response) throws Exception {
        ...
        if (Controller.appManager.addApp(srcFile)) {
    ...
    public void delete(Request request, Response response) throws Exception {
        ...
        Map<String, String> app = getDataStore().getDataById("appversion", id);
        if (app == null || app.isEmpty()) {
            return;
        }
        List<Map<String, String>> instanceList = getDataStore().getDataByKey("node", "app", id);
        if (instanceList != null && instanceList.size() > 0) {
            String thisModel = I18n.getString(qingzhou.framework.api.Constants.MASTER_APP_NAME, "model." + request.getModelName()) + "(" + id + ")";
            String detail = String.format(I18n.getString(qingzhou.framework.api.Constants.MASTER_APP_NAME, "validator.hasRefModel"), thisModel, I18n.getString(qingzhou.framework.api.Constants.MASTER_APP_NAME, "model." + Constants.MODEL_NAME_node));
            response.setSuccess(false);
        ...
        if (ConsoleWarHelper.getAppInfoManager().aremoveApp(filename)) {
    ...
    public void list(Request request, Response response) throws Exception {
        int pageNum = 1;
        String pageNumParameter = request.getParameter(ListModel.PARAMETER_PAGE_NUM);
        ...
        List<String> appNames = new ArrayList<>(Controller.appManager.getApps());
    ...
    @Override
    public List<String> getAllDataId(String modelName) {
        return new ArrayList<>(Controller.appManager.getApps());
    }
