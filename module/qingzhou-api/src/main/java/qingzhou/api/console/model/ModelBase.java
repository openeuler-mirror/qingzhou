...
public abstract class ModelBase implements ShowModel {
    ...
    public ConsoleContext getConsoleContext() {
        return AppContextHelper.getAppContext().getConsoleContext();
    }
    ...
    public OptionManager fieldOptions(Request request, String fieldName) {
        ModelField modelField = getConsoleContext().getModelManager().getModelField(request.getModelName(), fieldName);
